  ...
  return (
   ...
   <div className="hero grid grid-cols-2">
    <div>
      ...
      <p className="">
        Saya saat ini bekerja sebagai IT Support disebuah lembaga pendidikan Internasional hampir 
        6 tahun. Saya mempunyai ketertarikan dalam bidang network engineer dan cybersecurity,terutama 
